...
This mailing list is only for discussing security vulnerabilities in hadoop 'source' code, **NOT** security vulnerabilities coming via thirdparty libraries. For security issues related to thirdparty libraries use the dev/user mailing lists.

The thridparty library versions in the upcoming releases can be checked here:
...
**Note:** Not all vulnerabilities coming from thirdparty libraries impact hadoop and it isn't possible to update every thirdparty library. Read a hadoop developer's point of view on upgrading thirdparty libraries [here](https://steveloughran.blogspot.com/2022/08/transitive-issues.html)
